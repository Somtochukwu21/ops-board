...
export function ConfirmModal({ isOpen, onClose, onConfirm, productName }: ConfirmModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="rounded-lg border border-border bg-card p-6 shadow-[0_10px_50px_rgba(0,0,0,0.1)] max-w-sm mx-4">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          This product already exists as a returned or failed delivery. Do you want to mark it as sold or create a new
          entry?
        </p>
        ...
        <div className="flex gap-3">
          ...
          <Button variant="outline" onClick={() => onConfirm("mark-sold")} className="flex-1">
            Mark as Sold
          </Button>
